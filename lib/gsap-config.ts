...
const activeScrollTriggers = new Map<string, ScrollTrigger>()
...
export const refreshAllScrollTriggers = () => {
  ...
  // Force a layout recalculation for better accuracy
  if (typeof window !== "undefined") {
    window.dispatchEvent(new Event("resize"))
  }
  console.log("Refreshed all ScrollTriggers with viewport optimization")
}

export const optimizeViewportHeight = () => {
