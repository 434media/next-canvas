          ...
          <div className="w-full lg:w-1/2 flex-1 lg:h-full relative flex items-end justify-center lg:justify-end min-h-0">
            ...
            >
              <Image
                ...
                fill
                className="object-contain object-bottom-right lg:object-right scale-[3.32] ml-2 md:ml-0 lg:scale-105 origin-bottom-right lg:origin-center translate-x-4 lg:translate-x-0"
                priority
