  ...
  return (
    <main className="relative min-h-screen w-full bg-white text-black overflow-hidden pt-16">
      ...
      <section className="relative h-[calc(100vh-4rem)] w-full flex flex-col lg:flex-row items-center justify-center overflow-hidden">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 lg:px-8 h-full flex flex-row items-center justify-between relative z-10 pt-20 lg:pt-0">
          ...
          <div className="w-1/2 lg:w-1/2 h-full relative flex items-end justify-end min-h-0">
            ...
            >
              <Image
                ...
                fill
                className="object-contain object-bottom-right lg:object-right scale-[1.8] lg:scale-105 origin-bottom-right lg:origin-center translate-x-8 lg:translate-x-0 translate-y-10 lg:translate-y-0"
                priority
